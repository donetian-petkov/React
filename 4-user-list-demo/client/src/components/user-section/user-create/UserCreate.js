...
export const UserCreate = ({onClose, onUserCreate}) => {
    ...
    const minLength = (e, lowerLimit) => {

        setErrors(oldValues => ({
            ...oldValues,
            [e.target.name]: values[e.target.name].length < lowerLimit
        }));
                    ...
                    <form onSubmit={submitHandler}>
                            ...
                            <div className="form-group">
                                ...
                                <div className="input-wrapper">
                                    ...
                                    <input id="firstName" name="firstName" type="text" value={values.firstName}
                                           onChange={changeHandler} onBlur={(e) => minLength(e, 3)}/>
                                </div>
                                {
                                    errors.firstName &&
                        ...
                        <div id="form-actions">
                            <button id="action-save" className="btn" type="submit"
                                    disabled={Object.values(errors).some(x => x)}>Save
                            </button>
